...
|------------|----------------------|------------|
| [01. Задача матчинга для рекомендательной системы ретейла.](https://github.com/htoniy/Data-Science_Classic-ML/tree/main/01_Product%20matching)          | В проекте представлена рекомендательная система, позволяющая предлагать продукццию магазина из имеющегося ассортимента на основании запроса пользователя.                     | В разработке.           |
|            |                      |            |
